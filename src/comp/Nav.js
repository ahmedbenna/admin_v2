...
import { Class, Dashboard, LocalHospital, LocationCity, People } from '@mui/icons-material';
  ...
  return (
    <Box sx={{  display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open} >
        ...
        <Divider />
        <List>
        <Link to='/' style={{ textDecoration: 'none', color: '#585959' }}>
              <ListItem button>
                <ListItemIcon>
                  <Dashboard />
                </ListItemIcon>
        ...
        <List>
            <ListItem disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                <ListItemText primary="d" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
        </List>
      </Drawer>
